...
- [Interface interativa (MCP Apps)](#interface-interativa-mcp-apps)
...
EBAY_MCP_UI=on                      # visualizações interativas; defina "off" para forçar JSON puro
```

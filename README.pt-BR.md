...
Um servidor local do [Model Context Protocol](https://modelcontextprotocol.io) que expõe **305 ferramentas** cobrindo **100% das Sell APIs do eBay** (274 endpoints) para assistentes de IA — estoque, processamento de pedidos, marketing, analytics e ferramentas para desenvolvedores.
...
305 ferramentas em 274 endpoints únicos — 100% das Sell APIs do eBay.

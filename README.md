...
A local [Model Context Protocol](https://modelcontextprotocol.io) server that exposes **305 tools** covering **100% of eBay's Sell APIs** (274 endpoints) to AI assistants — inventory, order fulfillment, marketing, analytics, and developer tools.
...
305 tools across 274 unique endpoints — 100% of eBay's Sell APIs.

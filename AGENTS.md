...
A local [MCP](https://modelcontextprotocol.io) server exposing 303 tools across 100% of eBay's Sell APIs. TypeScript/Node.js (ESM), built with `@modelcontextprotocol/sdk`, Effect-backed validation, a Zod SDK adapter, and OpenAPI-generated types.
...
| `config/`        | Environment loading, constants, marketplace defaults, local-media allowlist (`mediaAccess.ts`)                                                                                                                                                                                                                                                                                         |
...
| `utils/`         | Platform primitives (logging, http, errors, effectSchema*, cliUi, `localMedia` file resolution) — not setup UX                                                                                                                                                                                                                                                             |

...
| [Trading (XML heredado)](src/tools/categories/trading.ts) | Crear, revisar, volver a publicar y finalizar anuncios de precio fijo; subida de imágenes alojadas en el sitio (EPS) |
